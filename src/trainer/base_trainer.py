...
class BaseTrainer:
    ...
    def __init__(
        ...
        # mixed-precision training (off by default; speeds up the conv-heavy DRUNets while the
        # ADMM/FISTA FFTs stay fp32 -- see b.float() in those models)
        self.use_amp = bool(self.config["trainer"].get("use_amp", False))
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        # unpickle the OmegaConf config / optimizer state stored in checkpoints.
        try:
